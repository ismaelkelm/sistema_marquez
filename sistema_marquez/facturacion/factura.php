...
<body>
    ...
    <form id="form-factura" action="cargaFactura.php" method="POST">
        ...
        <input type="number" step="0.01" id="impuestos" name="impuestos" required><br><br>

        <label for="total_factura">Total:</label>
        <input type="number" step="0.01" id="total_factura" name="total_factura" required><br><br>
        ...
        <label for="id_pedido_reparacion">ID Pedido de Reparación:</label>
        <input type="number" id="id_pedido_reparacion" name="id_pedido_reparacion"><br><br>
