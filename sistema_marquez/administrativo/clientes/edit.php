...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE clientes SET nombre='$nombre', apellido='$apellido', telefono='$telefono', correo_electronico='$correo_electronico', direccion='$direccion', dni='$dni' WHERE id_clientes=$id_clientes";
